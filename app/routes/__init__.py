...
def register_blueprints(app):
    ...
    # Dividend routes
    from app.routes.dividend import dividend_bp
    app.register_blueprint(dividend_bp, url_prefix='/api/dividend')

    print("[OK] All Blueprints registered (KR + US + Crypto + Econ + Dividend)")
