                                ...
                                <tr key={user.id} className="border-b border-white/5 hover:bg-white/[0.02]">
                                    ...
                                    <td className="px-4 py-3">
                                        <select
                                            ...
                                            className={`text-xs px-2 py-1 rounded border-0 focus:outline-none cursor-pointer ${user.tier === 'pro' ? 'bg-purple-500/20 text-purple-400' : 'bg-gray-500/20 text-gray-400'}`}
                                        >
                                            <option value="free">Free</option>
                                            <option value="pro">Pro</option>
                                        </select>
                                    ...
                                    <td className="px-4 py-3">
                                        <span className={`text-xs px-2 py-1 rounded ${user.subscription_status === 'active' ? 'bg-green-500/20 text-green-400' : user.subscription_status === 'pending' ? 'bg-yellow-500/20 text-yellow-400' : 'bg-gray-500/20 text-gray-500'}`}>
